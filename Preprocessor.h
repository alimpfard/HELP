...
//typedef std::__cxx11::basic_string std::basic_string
...
class Preprocessor {
    ...
    void handleDefineMacro(const std::string& token, const std::string& defintin, const LineIterator& line);
